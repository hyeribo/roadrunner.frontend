const en = {
  translation: {
    ...
    lbl_cash: "Cash",
    lbl_bank: "Bank",
    lbl_ex_active_area: "ex) Dormitory A, B, C",
    lbl_ex_message: "ex) I will buy the product you need.",
    lbl_help_estimated_time: "It helps customers make decisions.",
    lbl_ex_estimated_time: "ex) I am going to visit the mart at 1 o'clock.",
    lbl_ex_introduce: "ex) I deliver it to the front of the house.",
    lbl_help_ruuner_tip: "* The tip is 10% of the total amount.",
    lbl_help_image: "If you have images, please add it.",
    lbl_negotiable: "Negotiable",
    lbl_help_surcharge: "* 5% surcharge for urgent",
    lbl_same_address: "Same as address",
    lbl_requesting: "Requesting",
    lbl_request_complete: "Request Complete",
    lbl_requesting_complete: "Requesting Complete",
    lbl_complete: "Complete",
    lbl_ones: "'s",
    lbl_request_delivery: "Delivery request",
    lbl_proposal_delivery: "Delivery request",
    lbl_chatting: "Chatting",
    lbl_accept: "Accept",
    lbl_confirm_complete: "Confirm",
    lbl_total_price: "Total price",
    lbl_runner_tip: "Runner Tip",
    lbl_help_tip_price: "10% of the item price",
    lbl_career: "completing {{count}} times",
    lbl_movable: "{{distance}} moveable",
    lbl_count_complete: "Complete",
    lbl_ing: "Processing",
    lbl_received_contact: "Received",
    lbl_basic_info: "Basic information",
    lbl_my_propsal: "My proposal",
    lbl_runners_propsal: "Runner's proposal",
    lbl_my_request: "My request",
    lbl_shoppers_request: "Shopper's request",
    lbl_write_date: "Date",
    lbl_expected_price: "Expected price",
    ...
    frm_file_ext: "You can only upload JPG/PNG file.",
    frm_file_size: "Image must smaller than 2MB.",
    ...
    cfm_write_proposal: "Would you like to register the proposal?",
    cfm_write_request: "Would you like to register the request?",
    cfm_accept_proposal: "Would you like to accept?",
    cfm_request_complete: "Would you like to request completion?",
    cfm_complete: "Do you want to complete it?",
    cfm_request_delivery: "Would you like to ask for an errand?",
    ...
    msg_write_proposal_s: "Proposal registration was successful.",
    msg_write_proposal_f: "Proposal registration failed.",
    msg_write_request_s: "Request registration was successful.",
    msg_write_request_f: "Request registration failed.",
    msg_accept_s: "It was accepted.",
    msg_complete_s: "It was completed.",
